...
type Broker interface {
	...
	SendMessage(destination string, message []byte) error 
}
...
func (b *brokerImpl) SendMessage(destination string, message []byte) error {
	b.conn.Send(destination, "application/json", message)
	return nil
}
